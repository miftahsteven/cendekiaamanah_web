...
export function HeroSectionSecondary({
  title,
  description,
  programImage,
  socialMedia,
  ...
  return (
    <div className="w-full space-y-12 pt-12 md:pt-18 md:py-18">
      ...
      <div className="md:hidden relative w-full aspect-square md:aspect-3/1 rounded-xl overflow-hidden bg-muted">
        <Image
          src={programImage}
          alt={`${title} Overview`}
          fill
      ...
      {/* Row 3: Landscape Image */}
      <div className="hidden md:block relative w-full aspect-square md:aspect-3/1 rounded-xl overflow-hidden bg-muted">
        <Image
          src={programImage}
          alt={`${title} Overview`}
          fill
